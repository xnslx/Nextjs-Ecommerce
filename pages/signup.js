...
function Signup(props) {
  ...
  return (
    <div className="flex flex-col mt-20 justify-around md:flex-row">
        <div className=" -mt-12 w-4/5 ml-auto mr-auto md:-mt-10 md:ml-16">
            <Image src="/images/signup.png" width={480} height={480} />
        </div>
        <section className="ml-auto mr-auto w-4/5 mb-8 md:w-2/3">
        <form onSubmit={submitHandler} className="flex flex-col md:w-4/5 h-2/3 mt-18 ">
            ...
            <div>
            <button className="h-10 w-full bg-gray-800 mb-2 mt-2 text-xs text-white rounded mr-1">SIGNUP</button>
            <Link href='/login'>
